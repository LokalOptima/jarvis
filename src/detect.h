...
static constexpr float JARVIS_STEP_PENALTY = 0.3f;
static constexpr int   JARVIS_ANCHOR_FRAMES = 5;    // template frames at each end weighted higher
static constexpr float JARVIS_ANCHOR_WEIGHT = 3.0f;  // cost multiplier for anchor frames
