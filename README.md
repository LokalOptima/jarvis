...
~/.cache/jarvis/        Runtime data (XDG_CACHE_HOME)
...
~/.config/jarvis/       Configuration (XDG_CONFIG_HOME)
  config.toml           Server config (generated by enrollment)
...
Jarvis j("~/.cache/jarvis/ggml-tiny.bin", "~/.cache/jarvis/silero_vad.bin");
j.set_ding("data/beep.wav");

j.add_keyword({"hey_jarvis", "~/.cache/jarvis/templates/hey_jarvis.tiny.bin", 0.35f});
